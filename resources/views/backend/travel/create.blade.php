                    ...
                    <div class="col-lg-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" method="post" action="{{ route('travel.store') }}">
                                    @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="location" class="form-control" id="inputProductTitle"
                                            placeholder="Enter location for travel">
                                    </div>
                                    <div class="mb-3">
                                        <label for="about" class="form-label">About Travel</label>
                                        <textarea id="mytextarea" name="about">This is so amazing</textarea>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="featured_event" class="form-label">Featured Event</label>
                                        <input type="text" name="featured_event" class="form-control"
                                            id="inputProductTitle" placeholder="Enter Event title">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="language" class="form-label">Language</label>
                                        <input type="text" name="language" class="form-control" id="inputProductTitle"
                                            placeholder="Enter the Language">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="foods" class="form-label">Foods</label>
                                        <input type="text" name="foods" class="form-control" id="inputProductTitle"
                                            placeholder="Enter foods">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="departure_date" class="form-label">Departure Date</label>
                                        <input type="date" name="departure_date" class="form-control"
                                            id="inputProductTitle" placeholder="Enter departure_date">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="duration" class="form-label">Duration</label>
                                        <input type="text" name="duration" class="form-control" id="inputProductTitle"
                                            placeholder="Enter departure_date">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="type" class="form-label">Type Travel</label>
                                        <input type="text" name="type" class="form-control" id="inputProductTitle"
                                            placeholder="Enter Holidays...">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="price" class="form-label">Price</label>
                                        <input type="text" name="price" class="form-control" id="inputProductTitle"
                                            placeholder="Enter departure_date">
                                    </div>
